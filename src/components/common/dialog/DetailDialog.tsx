            ...
            <div className={styles.container__dialog}>
                <div className={styles.container__dialog__header}>
                    <div className={styles.close}>
                        ...
                        <img src="" alt="사진작가 프로필 사진" title="사진작가 프로필 사진" className={styles.close__authorImage} />
                        <span className={styles.close__authorName}>ngins7512</span>
                    </div>
                ...
                <div className={styles.container__dialog__footer}>
                    <div className={styles.infoBox}>
                        <div className={styles.infoBox_item}>
                            ...
                            <span className={styles.infoBox__item__value}>이미지 데이터 조회</span>
                        </div>
                        <div className={styles.infoBox_item}>
                            <span className={styles.infoBox__item__label}>이미지 크기</span>
                            <span className={styles.infoBox__item__value}>이미지 데이터 조회</span>
